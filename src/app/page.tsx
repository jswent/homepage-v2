...
import logoSwent from '@/images/logos/s-logo.png'
import logoTransocean from '@/images/logos/transocean.svg'
import logoStA from '@/images/logos/sta.png'
import logoLearnsight from '@/images/logos/learnsight.svg'
import logoSandbox from '@/images/logos/mit-sbif.svg'
...
function Resume() {
  let resume: Array<Role> = [
    ...
    {
      company: 'MIT Sandbox Innovation Fund',
      title: 'Mgr, Systems & Development',
      logo: logoSandbox,
      start: '2023',
      end: {
        label: 'Present',
      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          ...
          <p className="mt-4 text-base text-zinc-600 dark:text-zinc-400">
            I&apos;m a tech entrepreneur and investor based in Cambridge, MA.
            I&apos;m the founder and CEO of Swent Consulting, a product
            development and advisory firm building innovative software
            solutions. I also help out running systems at MIT&apos;s Sandbox
          ...
          <div className="mt-6 flex gap-6">
            ...
            />
            <SocialLink
              href="https://twitter.com/JamesSwent"
